...
class GearsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gear" do
    assert_difference('Gear.count') do
      post gears_url, params: { gear: { description: @gear.description, expiry-date: @gear.expiry-date, installation-date: @gear.installation-date, name: @gear.name, serie: @gear.serie } }
    end
  ...
  test "should update gear" do
    patch gear_url(@gear), params: { gear: { description: @gear.description, expiry-date: @gear.expiry-date, installation-date: @gear.installation-date, name: @gear.name, serie: @gear.serie } }
